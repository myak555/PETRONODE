        ...
        public SlideDescriptionFile(string definition)
        {
            ...
            try
            {
                ...
                while (true)
                {
                    ...
                    if (ss[0] == "raster")
                    {
                        LastSlide.Components.Add(new SlideComponentRaster(LastSlide, ss));
                        continue;
                    }
                    if (ss[0] == "rasterover")
                    {
                        LastSlide.Components.Add(new SlideComponentRasterOver(LastSlide, ss));
                        continue;
                    }
                    if (ss[0] == "log")
                    {
                        LastSlide.Components.Add(new SlideComponentLog(LastSlide, ss));
                        continue;
                    }
                    if (ss[0] == "dots")
                    {
                        LastSlide.Components.Add(new SlideComponentDot(LastSlide, ss));
                        continue;
                    }
                    if (ss[0] == "text")
                    {
                    ...
                    if (ss[0] == "unconformity")
                    {
                        LastSlide.Components.Add(new SlideComponentUnconformity(LastSlide, ss));
                        continue;
                    }
                    if (ss[0] == "recolor")
                    {
                    ...
                    if (ss[0] == "pixelcount")
                    {
                        LastSlide.Components.Add(new SlideComponentPixelCount(LastSlide, ss));
                        continue;
                    }
                    if (ss[0] == "extract")
                    {
                        LastSlide.Components.Add(new SlideComponentExtract(LastSlide, ss));
                        continue;
                    }
