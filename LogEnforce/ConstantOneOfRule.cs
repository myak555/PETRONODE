...
{
    public class ConstantOneOfRule: Rule
    {
        ...
        public ConstantOneOfRule(XmlNode node)
            : base(node)
        {
        ...
        public override void Enforce(LAS_File las)
        {
            ...
            {
                this.Status = "Warning";
                this.Comment = "Constant " + Constant + " is set to [" + lc + "] but [" + ret + "] is required.";
                return;
            }
            this.Status = Severity;
            StringBuilder sb = new StringBuilder();
            sb.Append("Constant " + Constant + " is set to [" + lc + "] but one of [");
