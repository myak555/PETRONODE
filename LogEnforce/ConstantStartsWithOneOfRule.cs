...
{
    public class ConstantStartsWithOneOfRule : Rule
    {
        ...
        public ConstantStartsWithOneOfRule(XmlNode node)
            : base(node)
        {
        ...
        public override void Enforce(LAS_File las)
        {
            ...
            {
                this.Status = "Warning";
                this.Comment = "Constant " + Constant + " is set to [" + lc + "] but but should start with [" + ret + "].";
                return;
            }
            this.Status = Severity;
            StringBuilder sb = new StringBuilder();
            sb.Append("Constant " + Constant + " is set to [" + lc + "] but should start with one of [");
